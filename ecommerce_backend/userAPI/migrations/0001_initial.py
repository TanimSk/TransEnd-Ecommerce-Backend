    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tracking_id', models.UUIDField(blank=True, editable=False, null=True)),
                ('per_price', models.IntegerField(blank=True, null=True)),
                ...
                ('consumer_email', models.EmailField(blank=True, max_length=100, null=True)),
                ('consumer_address', models.CharField(blank=True, max_length=500, null=True)),
                ('special_instructions', models.CharField(blank=True, max_length=500, null=True)),
                ('payment_method', models.CharField(choices=[('cod', 'cod'), ('mobile', 'mobile')], max_length=20)),
